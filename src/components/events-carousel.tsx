      ...
      <div className="overflow-hidden bg-white py-24 sm:py-32">
        ...
        >
          <div className="flex flex-col gap-4 text-center">
            <h2 className="font-cooper text-blue text-4xl sm:text-5xl">
              Our events
            </h2>
            <p className="sm:text-lg">
              Explore our fundraising events and how our community supports
              animals around the world.
            </p>
            <Button asChild variant={"teal"} className="mx-auto">
              <Link href="/events">
                All events
          ...
          <div className="flex items-center justify-center sm:justify-end">
            {/* <Button asChild variant={"teal"} className="group mr-auto">
              <Link href="/events">
                All events
                <ArrowRight className="-mr-2" />
              </Link>
